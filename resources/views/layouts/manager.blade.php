                    ...
                    <ul class="sidebar-nav">
                        <li>
                            <a href="{{ url("/home") }}" class=" active">
                                ...
                                <span class="sidebar-nav-mini-hide">Home 「当前{{ session("platform") == 0 ? "前台" : "后台"  }}」</span>
                            </a>
                        </li>
                                ...
                                @if($per['children'])
                                    <ul>
                                        @foreach($per['children'] as $ch)
                                            @if($ch['type'] == 0)
                                                <li>
                                                    <a href="{{ $ch['display_name'] ? (\Route::has($ch['display_name']) ? route($ch['display_name']) : 'javascript:;'):'javascript:;' }}"
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            {{--</li>--}}
                            <li>
                                <form action="{{ route('set-platform') }}" method="post" id="platform">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="platform" value="{{ session("platform") == 1 ? 0 :1  }}">
                                </form>
                                <a href="#" onclick="$('#platform').submit();">
                                    <i class="gi gi-lock fa-fw pull-right"></i>
                                    进入{{ session("platform") == 1 ? "前台" : "后台"  }}
                                </a>
                            </li>
                            <li>
