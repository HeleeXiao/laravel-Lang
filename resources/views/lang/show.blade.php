                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="text" id="example-validation-username" name="title"
                                   ...
                                   aria-invalid="true" value="{{ $lang->title }}" disabled
                            >
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="text" id="example-validation-username" name="url"
                                   ...
                                   required="" aria-required="true" aria-describedby="example-validation-username-error"
                                   aria-invalid="true" value="{{ url('/').'/'. $lang->url }}" disabled
                                    >
                            <span class="input-group-addon">
                                <i class="gi gi-asterisk"></i>
                            </span>
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <select id="val-skill" name="person" class="form-control" disabled>
                                <option value="{{ $lang->person }}" >{{ $lang->personUser->name }}</option>
                            </select>
                            <span class="input-group-addon">
                                <i class="gi gi-asterisk"></i>
                            </span>
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <select id="val-skill" name="sponsor" class="form-control" disabled>
                                <option value="" >{{ $lang->sponsorUser->name }}</option>
                            </select>
                            <span class="input-group-addon">
                                <i class="gi gi-asterisk"></i>
                            </span>
                                    ...
                                    <tr class="active">
                                        ...
                                        <td>
                                            <input type="text" name="word[chinese][]"
                                                   ...
                                                   required="" aria-required="true" aria-describedby="example-validation-username-error"
                                                   aria-invalid="true" value="{{ $word->chinese }}" readonly
                                                    >
                                        </td>
                                        <td>
                                            <input type="text" name="word[japanese][]"
                                                   ...
                                                   required="" aria-required="true" aria-describedby="example-validation-username-error"
                                                   aria-invalid="true" value="{{ $word->japanese }}" readonly
                                                    >
                                        </td>
